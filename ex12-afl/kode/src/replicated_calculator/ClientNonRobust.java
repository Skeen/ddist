...
{    
     ...
     */
    synchronized public boolean connect(InetSocketAddress addressOfServer, String clientName) 
	{
        int myPort = -1;
		...
		try 
		{
			...
			myPort = this.fromServer.listenOnPort(Parameters.getClientPortForServer());
			toServer.put(new ClientEventConnect(clientName,eventID++,new InetSocketAddress(myAddress,myPort)));
		} 
		catch (IOException e) 
		{
        ...
        Parameters.setPorts(-1, myPort, -1);
		this.start();
        return true;
    }
